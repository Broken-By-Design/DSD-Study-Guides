...
def get_check_client_ID ():
    ...
    while valid == False:
        clientID = input('Please enter the Client_ID number: ')
        if len(clientID) != 10 :
            print('Client ID must be 10 characters long')

            valid = False
        else:
            print('Client_ID accepted')
...
def get_check_investment_amount ():
    ...
    while valid == False:
        ...
        try:
            ...
            print('You did not enter an approroriate number format.')
            print('Please try again')
            valid = False
        else:
            print('Investment amount acepted')
...
def savings_plan (investmentAmount):
    ...
    print('')
    print('If the savings plan perfoms at the highest rate after 5 years you can expect:')
    print('Value of investment: £ {:.2f}'.format(maximumValue))
    print('Fees paid: £ {:.2f}'.format(feesMax))
    print('Profit made: £ {:.2f}'.format(maxProfit))
    print('')
    print('If the savings plan perfoms at the lowest rate after 5 years you can expect:')
...
def managed_stocks (investmentAmount):
    ...
    print('Initial Investment: £ {}'.format(investmentAmount))
    print('')
    print('If the managed stocks plan perfoms at the highest rate after 5 years you can expect:')
    print('Value of investment: £ {}'.format(maximumValue))
    print('Fees paid: £ {}'.format(feesMax))
    print('Profit made: £ {}'.format(maxProfit))
    print('')
    print('If the managed stocks plan perfoms at the lowest rate after 5 years you can expect:')
